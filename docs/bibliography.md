...
* [High Performance JavaScript by Nicholas C. Zakas](https://www.google.com/search?q=high+performance+javascript&oq=high+performance+javascript&aqs=chrome..69i57j0l5.2601j0j1&sourceid=chrome&ie=UTF-8#q=high+performance+Javascript+by+Nicholas+C.+Zakas).
